...
public class Profile_Activity extends AppCompatActivity {
    ...
    private TextView txt_profile_name, txt_profile_email, txt_profile_phone, txt_uploading;
    ...
    //LottieAnimationView object for showing animation.
    private LottieAnimationView anim_uploading, anim_loading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anim_uploading=findViewById(R.id.anim_uploading);
        txt_uploading=findViewById(R.id.txt_uploading);
        anim_loading=findViewById(R.id.anim_loading);

        //Setting the visibility of animation and txt_uploading
        anim_uploading.setVisibility(View.INVISIBLE);
        txt_uploading.setVisibility(View.INVISIBLE);
        anim_loading.setVisibility(View.VISIBLE);

        //Method to get current user Firebase UID.
        getUserFirebaseUID();
    ...
    //Method to get current user Firebase UID.
    private void getUserFirebaseUID() {
        ...
        if(FirebaseAuth.getInstance().getCurrentUser()!=null){
            ...
            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    //Making the animation invisible.
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch(menuItem.getItemId()){
                    ...
                    case R.id.menu_Complaints:{
                        startActivity(new Intent(Profile_Activity.this, Complaints_List.class));
                        break;
                    }
                }
                return false;
    ...
    private void saveProfileImageToCloud() {
        ...
        anim_uploading.setVisibility(View.VISIBLE);
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                //String the uploaded image Firebase storage url to Firebase Realtime database.
                DatabaseReference userReference=FirebaseDatabase.getInstance().getReference().child("actors").child("citizens").child(userId);
